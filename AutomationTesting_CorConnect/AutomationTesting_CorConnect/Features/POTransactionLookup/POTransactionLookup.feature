...
Background: Load Application with given user and navigate
	Given User "Admin" is on "PO Transaction Lookup" page

#TASK CON-20036: Last 185 days Date Range Search Option

@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify DateRange dropdown values on POTransactionLookup
    Then Dropdown "Date Range" should have valid values on "PO Transaction Lookup" page


@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Last 7 Days on POTransactionLookup
	When Search by DateRange value "Last 7 days"
	Then Data for "Last 7 days" is shown on the results grid


@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Last 14 Days on POTransactionLookup
	When Search by DateRange value "Last 14 days"
	Then Data for "Last 14 days" is shown on the results grid

@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Last 185 Days on POTransactionLookup
	When Search by DateRange value "Last 185 days"
	Then Data for "Last 185 days" is shown on the results grid
	
@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Current month on POTransactionLookup
	When Search by DateRange value "Current month"
	Then Data for "Current month" is shown on the results grid

@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Last month on POTransactionLookup
	When Search by DateRange value "Last month"
	Then Data for "Last month" is shown on the results grid

@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Customized date on POTransactionLookup
	When Search by DateRange value "Customized date"
	Then Data for "Customized date" is shown on the results grid


@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify that selecting Last 7 days date range option sets the correct From and To dates on POTransactionLookup
...
@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify that selecting Last 14 days date range option sets the correct From and To dates on POTransactionLookup
...
@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify that selecting Last 185 days date range option sets the correct From and To dates on POTransactionLookup
...
@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify that selecting Current month date range option sets the correct From and To dates on POTransactionLookup
...
@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify that selecting Last month date range option sets the correct From and To dates on POTransactionLookup
...
@CON-20036 @Functional @Smoke @POTransactionLookup @18.0
Scenario: Verify that selecting Customized date date range option sets the correct From and To dates on POTransactionLookup
