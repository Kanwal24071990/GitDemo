...
Background: Load Application with given user and navigate
	Given User "Admin" is on "Dealer Invoices" page

#TASK CON-20036: Last 185 days Date Range Search Option

@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify DateRange dropdown values on DealerInvoices
    Then Dropdown "Date Range" should have valid values on "Dealer Invoices" page

@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Last 7 Days on DealerInvoices
	When Advanced Search by DateRange value "Last 7 days"
	Then Data for "Last 7 days" is shown on the results grid
			
@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Last 14 Days on DealerInvoices
	When Advanced Search by DateRange value "Last 14 days"
	Then Data for "Last 14 days" is shown on the results grid

@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Last 185 Days on DealerInvoices
	When Advanced Search by DateRange value "Last 185 days"
	Then Data for "Last 185 days" is shown on the results grid
	
@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Current month on DealerInvoices
	When Advanced Search by DateRange value "Current month"
	Then Data for "Current month" is shown on the results grid

@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Last month on DealerInvoices
	When Advanced Search by DateRange value "Last month"
	Then Data for "Last month" is shown on the results grid

@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify Search By DateRange Dropdown When Value is Customized date on DealerInvoices
	When Advanced Search by DateRange value "Customized date"
	Then Data for "Customized date" is shown on the results grid

@CON-20036 @Functional @Smoke @DealerInvoices @18.0 @UAT
Scenario: Verify the Last 185 days date range message on Advanced Search on DealerInvoices
	When User navigates to Advanced Search
	Then The message "Advanced Search will only allow 185 days date range" is shown

@CON-20036 @Functional @Smoke @DealerInvoices @18.0 @UAT
Scenario: Verify the Date Range message when user selects FROM date greater than 185 days on DealerInvoices
...
@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify that selecting Last 7 days date range option sets the correct From and To dates on DealerInvoices
...
@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify that selecting Last 14 days date range option sets the correct From and To dates on DealerInvoices
...
@CON-20036 @Functional @Smoke @DealerInvoices @18.0 @UAT
Scenario: Verify that selecting Last 185 days date range option sets the correct From and To dates on DealerInvoices
...
@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify that selecting Current month date range option sets the correct From and To dates on DealerInvoices
...
@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify that selecting Last month date range option sets the correct From and To dates on DealerInvoices
...
@CON-20036 @Functional @Smoke @DealerInvoices @18.0
Scenario: Verify that selecting Customized date date range option sets the correct From and To dates on DealerInvoices
